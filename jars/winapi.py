...
kernel32dll = ctypes.WinDLL('kernel32.dll')
mprdll = ctypes.WinDLL('mpr.dll')
shell32dll = ctypes.WinDLL('shell32.dll')
...
CreateFile = kernel32dll.CreateFileW
...
GetFileInformationByHandle = kernel32dll.GetFileInformationByHandle
...
try:
    ReadDirectoryChangesW = kernel32dll.ReadDirectoryChangesW
...
CreateFileW = kernel32dll.CreateFileW
...
CreateHardLinkW = kernel32dll.CreateHardLinkW
CreateHardLinkW.restype = ctypes.wintypes.BOOL
CreateHardLinkW.errcheck = _errcheck_bool
...
MoveFileW = kernel32dll.MoveFileW
MoveFileW.restype = ctypes.wintypes.BOOL
MoveFileW.errcheck = _errcheck_bool
MoveFileW.argtypes = (
    ctypes.wintypes.LPCWSTR,  # lpExistingFileName
...
CreateEvent = kernel32dll.CreateEventW
...
GetLongPathName = kernel32dll.GetLongPathNameW
...
# );
SetFileAttributes = kernel32dll.SetFileAttributesW
...
# );
GetDiskFreeSpaceEx = kernel32dll.GetDiskFreeSpaceExW
...
#   _In_ DWORD         dwFlags
# );
WNetAddConnection2 = mprdll.WNetAddConnection2W
...
WaitForSingleObjectEx = kernel32dll.WaitForSingleObjectEx
...
CreateIoCompletionPort = kernel32dll.CreateIoCompletionPort
...
GetQueuedCompletionStatus = kernel32dll.GetQueuedCompletionStatus
...
PostQueuedCompletionStatus = kernel32dll.PostQueuedCompletionStatus
...
# );
SHChangeNotify = shell32dll.SHChangeNotify
